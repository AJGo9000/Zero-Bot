...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=628885156961:+5527995332408\n' // WhatsApp ID + phone number
            + 'END:VCARD'
prefix = botPrefix
blocked = []
				...
				case 'demote':
					...
					break
                                case 'randomhentai':
                                        ...
                                        nzwa.sendMessage(from, buffer, image, {quoted: mek, caption: 'Punheteiro 2D KAKAKAKA'})
